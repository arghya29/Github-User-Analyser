...
export default function AiInsightPanel({
  ...
  const generate = async (type: InsightType) => {
    ...
    const weekdayPct =
      productivity && total > 0 ? Math.round((productivity.weekdayCount / total) * 100) : undefined
  ...
  return (
    <div className="bg-white dark:bg-slate-700/50 border border-gray-200 dark:border-slate-600 rounded-lg p-6">
      ...
      <p className="text-xs text-gray-500 dark:text-gray-400 mb-4">
        Generated by AI from this profile&apos;s public data — for fun, double-check before using
        anywhere serious.
      </p>
